...
import axios from "axios";
 ...
 const ProfessionalCalender=()=> {
    const [showComponent, setShowComponent] = useState(true);
    const professionalEmail = localStorage.getItem("user_email"); // To pass in request
    ...
    const transformedEvents = events.map(event => {
      ...
      return {
        ...
        title: event.is_available ? 'Sheduled' : 'Completed',
        start: start.toDate(),
        end: end.toDate(),
      };
    });
...
export default ProfessionalCalender